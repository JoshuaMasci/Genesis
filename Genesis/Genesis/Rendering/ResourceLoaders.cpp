...
MeshTemp ObjLoader::loadMesh_CalcTangent(RenderingBackend* backend, string mesh_file_path)
{
	struct TexturedVertex
	{
		vector3F pos;
...
MeshTemp AssimpLoader::loadMesh(RenderingBackend* backend, string file_path)
{
