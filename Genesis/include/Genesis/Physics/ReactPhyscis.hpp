...
namespace Genesis
{
	...
	inline reactphysics3d::Vector2 toVec2R(const vector2F& vec) { return reactphysics3d::Vector2((double)vec.x, (double)vec.y); };
	inline reactphysics3d::Vector3 toVec3R(const vector3F& vec) { return reactphysics3d::Vector3((double)vec.x, (double)vec.y, (double)vec.z); };
	inline reactphysics3d::Quaternion toQuatR(const quaternionF& quat) { return reactphysics3d::Quaternion((double)quat.x, (double)quat.y, (double)quat.z, (double)quat.w); };
