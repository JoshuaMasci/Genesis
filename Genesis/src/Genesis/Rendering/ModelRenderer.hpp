...
namespace Genesis
{
	...
	public:
		...
		void drawDirectional(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, DirectionalLight& light, vector3F& light_dir);
		void drawPoint(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, PointLight& light, vector3F& light_pos);
		void drawSpot(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, SpotLight& light, vector3F& light_pos, vector3F& light_dir);

		void drawShadow(CommandBuffer* command_buffer, Mesh& mesh, matrix4F& view_proj_matrix, matrix4F& model_matrix);

		void drawDirectionalShadow(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, DirectionalLight& light, vector3F& light_dir, View& shadow_view, matrix4F& shadow_matrix);
		void drawSpotShadow(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, SpotLight& light, vector3F& light_pos, vector3F& light_dir, View& shadow_view, matrix4F& shadow_matrix);
