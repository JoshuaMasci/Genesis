...
namespace Genesis
{
	...
	public:
		...
		void drawAmbient(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& height_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, vector3F& ambient_light);

		void drawDirectional(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, Texture& height_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, DirectionalLight& light, vector3F& light_dir);
		void drawPoint(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, Texture& height_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, PointLight& light, vector3F& light_pos);
		void drawSpot(CommandBuffer* command_buffer, Mesh& mesh, Texture& albedo_texture, Texture& normal_texture, Texture& height_texture, matrix4F& view_proj_matrix, matrix4F& model_matrix, matrix3F& normal_matrix, vector3F& eye_pos, SpotLight& light, vector3F& light_pos, vector3F& light_dir);
